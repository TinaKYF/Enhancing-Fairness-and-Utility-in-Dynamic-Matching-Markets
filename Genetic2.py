...
class GeneticAlgorithm2:
    ...
    def __init__(self, startTime=0, endTime=0, updateTime=1, carParkMap=None, stayProList=None,clusterType=None):
    ...
    def execute(self):
        ...
        fileName = 'genetic2_' + self.clusterType + '_result.csv'
        titles = ['runTime', 'stopTime', 'startTime', 'endTime', 'updateTime', 'popuSize', 'crossRate', 'mutateRate',
                  ...
                  'officerdis_record', 'stdofficerdis_record',"officerBenefit","stdofficerBenefit"]
