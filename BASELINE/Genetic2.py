...
class GeneticAlgorithm2:
    ...
    def execute(self):
        ...
        titles = ['runTime', 'stopTime', 'startTime', 'endTime', 'updateTime', 'popuSize', 'crossRate', 'mutateRate',
                  ...
                  'officerdis_record', 'stdofficerdis_record' ,"officerBenefit", "stdofficerBenefit", "waitList", "stdWait"]
        params = [runTime, stopTime, self.startTime, self.endTime, self.updateTime, self.populationSize, self.crossRate,
                  ...
                  self.validCapturedTime,officerdis_record, stdofficerdis_record , officerBenefit, stdofficerBenefit,waitList, stdWait]
