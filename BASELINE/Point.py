...
class Point:
    ...
    def __init__(self, marker, tripDistance,requestTime,aimMarker,center,centralMarker,centralAimMarker):
        self.marker = marker
        self.aimMarker=aimMarker
        ...
        self.center=center#cluster的标号
        self.centralMarker=centralMarker
        self.centralAimMarker=centralAimMarker
        self.takeTime=None
        # self.count=False
