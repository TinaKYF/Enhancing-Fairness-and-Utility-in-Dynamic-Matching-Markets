...
class PSOAlgorithm:
    ...
    def execute(self):
        ...
        titles = ['runTime', 'stopTime', 'startTime', 'endTime', 'updateTime', 'popuSize', 'w', 'c1', 'c2', 'minX',
                  'maxX', 'updateRate', 'pointNumLoc', 'doLocRate', 'maxGen', 'proThreshold', 'validCapturedTime','officerdis_record', 'stdofficerdis_record',"officerBenefit", "stdofficerBenefit", "waitList", "stdWait"]
        params = [runTime, stopTime, self.startTime, self.endTime, self.updateTime, self.popuSize, self.w, self.c1,
                  ...
                  self.proThreshold, self.validCapturedTime,officerdis_record, stdofficerdis_record, officerBenefit, stdofficerBenefit,waitList, stdWait]
