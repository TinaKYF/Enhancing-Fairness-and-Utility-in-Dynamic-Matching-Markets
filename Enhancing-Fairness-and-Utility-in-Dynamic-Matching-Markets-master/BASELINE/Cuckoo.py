...
class CuckooAlgorithm:
    ...
    def execute(self):
        ...
        titles = ['runTime', 'stopTime', 'startTime', 'endTime', 'updateTime', 'nestSize', 'pc', 'pa', 'preFlyRate',
                  'pointNumLoc', 'doLocRate', 'lambda_', 'stepSide', 'maxGen', 'proThreshold', 'validCapturedTime','officerdis_record', 'stdofficerdis_record',"officerBenefit", "stdofficerBenefit", "waitList", "stdWait"]
        params = [runTime, stopTime, self.startTime, self.endTime, self.updateTime, self.nestSize,
                  ...
                  self.maxGen, self.proThreshold, self.validCapturedTime,officerdis_record, stdofficerdis_record, officerBenefit, stdofficerBenefit,waitList, stdWait]
    ...
    def localOptimisation(self, path):
        ...
        for i, ele in enumerate(path):  # ele will be ['3357s', 1.2345]
            if 'O' in ele[0] or i == pathEndNodeI:
                ...
                nodesNum = subPathEndI - offiIndex
